...
shift_sd_array = np.array([0.9,0.7,0.5,0.3])

for m in binned:
    if m == 'unbinned_SAP':
        writer = pd.ExcelWriter('./output/a2a_vary_sigma_unbinnedSAP_revised' +str(np.int(np.round(10000*random.random())))+'.xlsx', engine='xlsxwriter')
